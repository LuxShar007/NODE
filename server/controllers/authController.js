...
exports.spotifyCallback = async (req, res) => {
  ...
  res.cookie('spotify_token', tokens.access_token, {httpOnly: true}).redirect('https://cubet.space/questions');
};
...
exports.youtubeCallback = async (req, res) => {
  ...
  res.cookie('youtube_token', data.access_token, {httpOnly: true}).redirect('https://cubet.space/questions');
};